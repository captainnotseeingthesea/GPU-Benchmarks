...
void copyToDevice(void* to_device, void* from_host, unsigned long bytes, cudaStream_t stream_app);
void copyFromDevice(void* to_host, void* from_device, unsigned long bytes, cudaStream_t stream_app);
