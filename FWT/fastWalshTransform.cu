...
int main_FWT(cudaStream_t stream_app, pthread_mutex_t *mutexapp, bool flag){
    ...
    printf("Initializing data...\n");
        ...
        cutilSafeCall( cudaMemcpyAsync(d_Kernel, h_Kernel, KERNEL_SIZE, cudaMemcpyHostToDevice, stream_app) );
        cutilSafeCall( cudaMemcpyAsync(d_Data,   h_Data,     DATA_SIZE, cudaMemcpyHostToDevice, stream_app) );
    ...
    cutilSafeCall( cudaMemcpyAsync(h_ResultGPU, d_Data, DATA_SIZE, cudaMemcpyDeviceToHost, stream_app) );
