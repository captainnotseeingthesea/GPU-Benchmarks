...
extern "C" void setConvolutionKernel(float *h_Kernel, cudaStream_t stream_app){
    cudaMemcpyToSymbolAsync(c_Kernel, h_Kernel, KERNEL_LENGTH * sizeof(float),0, cudaMemcpyHostToDevice, stream_app);
}
...
extern "C" void convolutionRowsGPU(
    ...
    float *d_Src,
    int imageW,
    int imageH,cudaStream_t stream_app
){
    ...
    convolutionRowsKernel<<<blocks, threads,0,stream_app>>>(
        d_Dst,
        d_Src,
        imageW,
        imageH,
...
extern "C" void convolutionColumnsGPU(
    ...
    convolutionColumnsKernel<<<blocks, threads,0, stream_app>>>(
        d_Dst,
        d_Src,
        imageW,
        imageH,
